...
/***/ }
/******/ ]);
angular.module("untitled1").run(["$templateCache", function($templateCache) {$templateCache.put("app/components/wordCloud/wordCloud.html","<div id=wordCloud class=\"word-cloud color\" ng-class=\"{\'selection-mode\': vm.selectionMode,\'hover-mode\':vm.hoveredMode}\"></div>");}]);
